...
import { PlusCircle, ArrowUpCircle, ArrowDownCircle, BarChart3, Clock, TrendingUp, DollarSign, CreditCard } from "lucide-react"
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div className={`h-10 w-10 rounded-full flex items-center justify-center ${
                      transaction.category === Category.Income ? 'bg-green-100' : 'bg-red-100'
                    }`}>
